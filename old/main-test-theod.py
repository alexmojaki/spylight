...
class MapSight(Widget):
    """docstring for MapSight"""
    def __init__(self, **args):
        super(MapSight, self).__init__(**args)
        self.alpha = 0.95

        
Factory.register("MapView", MapView)
Factory.register("MapSpot", MapSpot)
Factory.register("MapSight", MapSight)
